...
Pour plus d'informations sur les contraintes de version, consultez la [documentation Composer](https://getcomposer.org/doc/articles/versions.md#version-constraints).
:::
...
- [PSR-4 sur PHP-FIG](https://www.php-fig.org/psr/psr-4/) - La spécification officielle
- [Autoloading dans la documentation Composer](https://getcomposer.org/doc/01-basic-usage.md#autoloading)
