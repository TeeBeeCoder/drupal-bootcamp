...
4. **Créer vite.config.js**
   ...
   <Aside type="tip">
     Assurez-vous que le `host` dans `hmr` correspond à l'URL de votre projet DDEV (`ddev describe`).
   </Aside>
...
3. **Ajouter les images**
   ...
   Copiez les images nécessaires (logo, icônes) dans `assets/images/`.
...
<Card title="Durée estimée : 10 minutes" icon="clock">
