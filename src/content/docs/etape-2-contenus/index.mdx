...
<Aside type="note" title="Génération de contenu">
Pour générer du contenu de test automatiquement, installez le module Devel Generate :
```bash
ddev composer require --dev drupal/devel
ddev drush en devel devel_generate -y
ddev drush genc 10 --bundles=product
```
</Aside>
