...
<Tabs>
  ...
  <TabItem label="Linux">
    ...
    # Ubuntu/Debian
    sudo apt update
    sudo apt install php8.4 php8.4-cli php8.4-common php8.4-mysql php8.4-xml php8.4-curl php8.4-gd php8.4-mbstring php8.4-zip
...
<Tabs>
  ...
  <TabItem label="Windows">
    ```powershell
    # Télécharger depuis [https://git-scm.com/download/win](https://git-scm.com/download/win)
...
<Tabs>
  <TabItem label="DDEV (Recommandé)">
    ...
    **Prérequis DDEV :**
    ...
    - Lien officiel : [ddev.com](https://ddev.com)
    :::
  </TabItem>
  <TabItem label="XAMPP">
    ...
    :::caution[Attention]
    Assurez-vous que XAMPP utilise PHP 8.4+. Les versions plus anciennes peuvent inclure PHP 8.1 ou 8.2.
    :::
  </TabItem>
</Tabs>
...
- **[PHPStorm](https://www.jetbrains.com/phpstorm/)** (payant, excellent support Drupal)
- **[Sublime Text](https://www.sublimetext.com/)** (éditeur léger et rapide)
- **[vscode](https://code.visualstudio.com/)** (gratuit et extensible)
- **[Helix](https://helix-editor.com/)** (vim like, pour les utilisateurs avancés)
...
- **[packagist.org](https://packagist.org)** - Dépôt Composer
- **[drupal.org](https://drupal.org)** - Modules et thèmes Drupal
- **[github.com](https://github.com)** - Code source et templates
