...
description: Objectifs pédagogiques, public cible et méthodologie du Drupal Bootcamp
sidebar:
  order: 1
---
...
- **Freelances** cherchant à ajouter Drupal à leurs compétences
...
- 🔧 **Configurations** - Exports Drupal pour chaque étape
...
3. Utilisez les **exports de configuration** fournis pour rattraper une étape

## 🚀 Commençons !

Avant de démarrer, assurez-vous que votre environnement répond aux [prérequis techniques](/prerequis/).
